...
public interface BRF1_Summary_Repo extends JpaRepository<BRF1_REPORT_ENTITY, Date> {
 
//	@Query(value = "SELECT * FROM BRF1_SUMMARYTABLE " +
...
//            "AND version = 'Archival'",
    nativeQuery = true)
	List<BRF1_REPORT_ENTITY> findByReportCodeAndDate(
     @Param("reportCode") String reportCode,
