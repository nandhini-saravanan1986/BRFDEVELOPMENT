...
@Entity
@Table(name="BRF4_ARCHIVTABLE")
public class BRF4_ARCHIVENTITY {
	...
	public BRF4_ARCHIVENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
