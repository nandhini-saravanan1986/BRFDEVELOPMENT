...
public interface BRF3_Summary_Repo extends JpaRepository<BRF003_ENTITY, Date>{
//	@Query(value = "SELECT * FROM BRF3_SUMMARYTABLE " +
...
//            "AND version = 'Archival'",
    nativeQuery = true)
	List<BRF003_ENTITY> findByReportCodeAndDate(
     @Param("reportCode") String reportCode,
