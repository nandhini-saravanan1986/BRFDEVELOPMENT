...
@Table(name="BRF4_DETAILTABLE")
public class BRF4_DETAIL_ENTITY {
	...
	public BRF4_DETAIL_ENTITY(String cust_id, String foracid, BigDecimal act_balance_amt_lc, BigDecimal eab_lc,
