...
@Entity
@Table(name = "BRF_USER_PROFILE_TABLE")
public class UserProfile implements UserDetails {
	...
	private String brf_configuration;
	private String brf_report;
	...
	public String getbrf_configuration() {
		return brf_configuration;
	}

	public void setbrf_configuration(String brf_configuration) {
		this.brf_configuration = brf_configuration;
	}

	public String getbrf_report() {
		return brf_report;
	}

	public void setbrf_report(String brf_report) {
		this.brf_report = brf_report;
	}
